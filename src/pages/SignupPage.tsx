...
export default function SignupPage() {
  ...
  const { signupWithEmail, loginWithGoogle, error, loading, clearError } = useAuthStore();
      ...
      >
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-white/60">Start managing your portfolio risk</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-white/60 text-sm">
              ...
              <Link to="/login" className="text-cyan hover:text-cyan-light transition-colors">
                Sign in
              </Link>
            </p>
          </div>
